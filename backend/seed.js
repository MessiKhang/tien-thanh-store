...
const seedData = async () => {
    try {
        ...
        const createProduct = (
            ...
            const totalStock = colorStocks.reduce(
                (sum, cs) => sum + cs.stock,
                0,
            );
        ...
        const products = await Product.insertMany([
            ...
            createProduct(
                ...
                categories[0]._id,
                "sale",
                [productImages[8], productImages[9]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "new",
                [productImages[22], productImages[23]],
            ),
            createProduct(
                "Laptop Dell G15 Gaming",
                21990000,
                12,
                "Dell",
                productImages[28],
                categories[0]._id,
                "sale",
                [productImages[29], productImages[0]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "sale",
                [productImages[15], productImages[16], productImages[17]],
            ),
            // Laptop Apple
            createProduct(
                ...
                categories[0]._id,
                "featured",
                [productImages[2], productImages[3], productImages[4]],
            ),
            createProduct(
                "MacBook Air M1",
                29990000,
                ...
                categories[0]._id,
                "new",
                [productImages[9], productImages[10]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "new",
                [productImages[16], productImages[17], productImages[18]],
            ),
            createProduct(
                "MacBook Air M2",
                32990000,
                ...
                categories[0]._id,
                "featured",
                [productImages[23], productImages[24]],
            ),
            // Laptop ASUS
            createProduct(
                ...
                categories[0]._id,
                "sale",
                [productImages[3], productImages[4], productImages[5]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "sale",
                [productImages[10], productImages[11]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "new",
                [productImages[17], productImages[18], productImages[19]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "sale",
                [productImages[24], productImages[25]],
            ),
            createProduct(
                "Laptop ASUS ProArt StudioBook",
                39990000,
                0,
                "ASUS",
                productImages[29],
                categories[0]._id,
                "featured",
                [productImages[0], productImages[1], productImages[2]],
            ),
            // Laptop HP
            createProduct(
                ...
                categories[0]._id,
                "new",
                [productImages[4], productImages[5]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "sale",
                [productImages[11], productImages[12], productImages[13]],
            ),
            createProduct(
                "Laptop HP Omen 16",
                28990000,
                ...
                categories[0]._id,
                "sale",
                [productImages[18], productImages[19]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "featured",
                [productImages[25], productImages[26], productImages[27]],
            ),
            // Laptop Lenovo
            createProduct(
                ...
                categories[0]._id,
                "new",
                [productImages[5], productImages[6], productImages[7]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "new",
                [productImages[12], productImages[13]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "featured",
                [productImages[19], productImages[20], productImages[21]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "sale",
                [productImages[26], productImages[27]],
            ),
            // Laptop Acer
            createProduct(
                ...
                categories[0]._id,
                "sale",
                [productImages[6], productImages[7], productImages[8]],
            ),
            createProduct(
                "Laptop Acer Nitro 5",
                19990000,
                ...
                categories[0]._id,
                "sale",
                [productImages[13], productImages[14]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "featured",
                [productImages[20], productImages[21], productImages[22]],
            ),
            createProduct(
                "Laptop Acer Swift 3",
                17990000,
                ...
                categories[0]._id,
                "new",
                [productImages[27], productImages[28]],
            ),
            // Laptop MSI
            createProduct(
                ...
                categories[0]._id,
                "new",
                [productImages[7], productImages[8], productImages[9]],
            ),
            createProduct(
                "Laptop MSI Creator Z16",
                34990000,
                0,
                "MSI",
                productImages[13],
                categories[0]._id,
                "featured",
                [productImages[14], productImages[15]],
            ),
            createProduct(
                "Laptop MSI Stealth 15M",
                37990000,
                5,
                "MSI",
                productImages[20],
                categories[0]._id,
                "new",
                [productImages[21], productImages[22], productImages[23]],
            ),
            createProduct(
                ...
                categories[0]._id,
                "sale",
                [productImages[28], productImages[29]],
            ),
        ]);
        ...
        for (let i = 0; i < numOrders; i++) {
            ...
            // Random user
            const user =
                userUsers[Math.floor(Math.random() * userUsers.length)];
            ...
            const originalTotal = selectedProducts.reduce((sum, item) => {
                ...
                return (
                    sum + (hasSale ? item.oldPrice : item.price) * item.quantity
                );
            }, 0);
        ...
        const newsData = [
            {
                ...
                summary:
                    "Chương trình ưu đãi đặc biệt dành cho học sinh, sinh viên và giáo viên với mức giảm giá lên đến 20%",
...
Thời gian áp dụng: Từ 01/09/2025 đến 30/09/2025`,
            ...
            },
            {
                ...
                summary:
                    "Chương trình khuyến mãi lớn nhất năm với hàng ngàn sản phẩm giảm giá sâu",
...
Áp dụng: Tất cả chi nhánh và website`,
            ...
            },
            {
                ...
                summary:
                    "Mua laptop được giảm thêm 500.000đ và nhận ngay quà tặng cao cấp",
...
Lưu ý: Chương trình có giới hạn số lượng, áp dụng cho khách hàng đầu tiên.`,
            ...
            },
            {
                ...
                summary:
                    "Giảm giá dịch vụ sửa chữa máy tính, laptop lên đến 15%",
...
Giảm 15% cho toàn bộ hóa đơn dịch vụ sửa chữa. Áp dụng từ 01/10/2025 đến 31/12/2025.`,
            ...
            },
            {
                ...
                summary:
                    "Khai trương chi nhánh mới với nhiều ưu đãi đặc biệt cho khách hàng",
...
Thời gian: 08:00 - 22:00 hàng ngày`,
            ...
            },
            {
                ...
                summary:
                    "Cập nhật chính sách đổi trả linh hoạt, dễ dàng hơn cho khách hàng",
...
Điều kiện: Có CMND/CCCD và thu nhập ổn định`,
            ...
            },
            {
                ...
                summary:
                    "Sale lớn cho các sản phẩm gaming: chuột, bàn phím, tai nghe",
...
Thương hiệu: Logitech, Razer, Corsair, SteelSeries, HyperX...`,
        ...
        for (let i = 0; i < numReviews; i++) {
            ...
            do {
                ...
                reviewedProducts.has(product._id.toString()) &&
                attempts <= 50
            );
            ...
            if (adminUser) {
                ...
                for (let i = 0; i < numReplies; i++) {
                    ...
                    if (!review.adminReply || !review.adminReply.text) {
                        ...
                        review.adminReply = {
                            text: adminReplyTexts[
                                Math.floor(
                                    Math.random() * adminReplyTexts.length,
                                )
                            ],
